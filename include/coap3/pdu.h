...
typedef enum coap_pdu_code_t {
  ...
  COAP_REQUEST_CODE_GET    = COAP_REQUEST_GET, // 1
  COAP_REQUEST_CODE_POST   = COAP_REQUEST_POST, // 2
  COAP_REQUEST_CODE_PUT    = COAP_REQUEST_PUT, // 3
  COAP_REQUEST_CODE_DELETE = COAP_REQUEST_DELETE, // 4
  COAP_REQUEST_CODE_FETCH  = COAP_REQUEST_FETCH, // 5
  COAP_REQUEST_CODE_PATCH  = COAP_REQUEST_PATCH, // 6
  COAP_REQUEST_CODE_IPATCH = COAP_REQUEST_IPATCH, // 7
